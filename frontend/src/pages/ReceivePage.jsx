    ...
    const handleClipboardPaste = async () => {
        try {
            ...
            if (navigator.clipboard && window.isSecureContext) {
                ...
                clipboardText =
                    prompt("Please paste the session code here:") || "";
            }
            if (clipboardText) {
            ...
            <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 text-[14px] sm:text-[16px]">
                                Enter the 8-character code provided by the
                                sender to receive files
                            </p>
                        </div>
                        {}
                        <div className="mb-8">
                ...
                {waitingForApproval && (
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Your connection request has been sent to the sender.
                ...
                {connectionStatus === "failed" && (
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Unable to connect to the sender. Please check the
                            session code and try again.
                        </p>
                        <button
                            onClick={() => {
